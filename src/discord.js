...
export class DiscordSide {
  constructor(cfg, store, onMessage) {
    ...
    //
    // Шлях не екзотичний: досить, щоб цикл подій на людній гільдії
    // перестрибнув тривисекундне вікно Discord -- і i.reply() відмовляє з
    // 10062 Unknown interaction, забираючи з собою все інше.
